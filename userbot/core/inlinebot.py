...
def main_menu():
    text = f"**▾∮ مرحبا عزيزي {mention}**\n**▾اليكَ قائمة بازرار مضمنة لاوامر ↫**⍣ⵧⵧⵧⵧⵧ𝙺𝚑𝚃𝚑𝚘𝚗ⵧⵧⵧⵧⵧ⍣**\n[𝑲𝒉𝒂𝒍𝒊𝑱𝑻𝒉𝑶𝒏 𝑼𝒔𝒆𝑹 𝑩𝑶𝑻](https://t.me/zVVVn)\n\n"
    buttons = [
...
async def inline_handler(event):
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        buttons = [
            (
                Button.url("قناة السورس", "t.me/zVVVn"),
                Button.url(
                    "المطور",
                    "t.me/YDDDE",
                ),
        ...
        text, msg_entities = await event.client._parse_message_text(
            "لجعل الخليج ثون من نصيبك!", "md"
        )
        result = types.InputBotInlineResult(
            id=str(uuid4()),
            type="photo",
            title="[𝐊𝐡𝐚𝐥𝐢𝐉𝐓𝐡𝐎𝐧 𝐔𝐬𝐞𝐑 𝐁𝐎𝐓](https://t.me/zvvvn)",
