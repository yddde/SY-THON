# 𝙆𝙝𝙖𝙡𝙞𝙅𝙏𝙝𝙤𝙉 𝘿𝙚𝙫𝙚𝙡𝙤𝙥𝙚𝙧 ⁦˖꒰  -
# كتابة وتعديل وترتيب  ~ @YDDDE
# For ~ @zVVVn
...
DEFAULTUSERBIO = DEFAULT_BIO or " 𝖪𝗁𝖺𝗅𝗂𝖩𝖳𝗁𝖮𝗇 𝖴𝗌𝖾𝖱 𝖡𝖮𝖳  || @zVVVn"
...
@jmthon.ar_cmd(
    pattern="الصوره الوقتيه$",
    command=("الصوره الوقتيه", plugin_category),
)
async def _(event):
    ...
    if gvarstatus("digitalpic") is not None and gvarstatus("digitalpic") == "true":
        return await edit_delete(event, "**الصـورة الوقتيه شغاله بالفعل  **")
...
async def _(event):
    ...
    if gvarstatus("autoname") is not None and gvarstatus("autoname") == "true":
        return await edit_delete(event, "**الاسـم الـوقتي شغـال بالفعل 🧸**")
...
async def _(event):
    ...
    if gvarstatus("autobio") is not None and gvarstatus("autobio") == "true":
        return await edit_delete(event, "**الـبايو الـوقتي شغـال بالفعل 🧸**")
...
async def _(event):  # sourcery no-metrics
    ...
    if input_str == "الصوره الوقتيه":
        ...
        return await edit_delete(event, "**لم يتم تفعيل الصورة الوقتية اساسا 🧸**")
