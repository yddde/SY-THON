...
# اوامر المجموعة ل سورس خليج ثون
# @YDDDE  -  @zVVVn
@jmthon.ar_cmd(
...
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
            "شـرح عـن اوامـر الـمنشن \n➖➖➖➖➖➖➖➖➖➖➖➖\n ⌯︙اختر احدى هذه الاوامر \n\n- ( `.منشن + معرف + نص` ) \n\n لعمل منشن لشخص في الكروب و وضع منشن في النص \n- مثـال | .مشنن` @zVVVn  ههلا` \n\n- ( `.للكل + نص` ) \n لعمل منشن للكل مع النص اكتب الامر مع النص وارسله فقط\n\n- ( `.ابلاغ` )\n بالرد على الشخص لعمل ابلاغ لمشرفين المجموعة \n\n➖➖➖➖➖➖➖➖➖➖➖➖\n⌯︙CH : @zVVVn"
        )
        # @YDDDE  -  @zVVVn
...
@jmthon.ar_cmd(
    pattern="اوامر الترجمه$",
    command=("اوامر الترجمه", plugin_category),
)
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
            "شـرح عـن اوامـر الترجمة \n➖➖➖➖➖➖➖➖➖➖➖➖\n ⌯︙اختر احدى هذه الاوامر \n\n- ( `.ترجمه ar` ) \n\n بالرد على النص لترجمته للغه العربية\n\n- ( `.ترجمه en` ) \n بالرد على النص لترجمته للغه الانقليزيه\n\n➖➖➖➖➖➖➖➖➖➖➖➖\n⌯︙CH : @zVVVn"
        )  # @GGGNE  -  @RR9R7
...
@jmthon.ar_cmd(
    pattern="اوامر قوقل$",
    command=("اوامر قوقل", plugin_category),
)
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
            "شرح اوامر قوقل :\n➖➖➖➖➖➖➖➖➖➖➖➖➖\n⌯︙اختر احدى هذه الاوامر\n\n- ( `.صور +  عدد الصور + نص` )\nللحصول على صور من متصفح قوقل بكتابة الامر وعدد الصور الحد 10 واسم النص\n\n➖➖➖➖➖➖➖➖➖➖➖➖➖\n⌔︙CH : @zVVVn"
        )
