...
@jmthon.ar_cmd(
    pattern="الزخرفه$",
    command=("الزخرفه", plugin_category),
)
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
            ...
            " `.زخرفه8`\n"
            " `.زخرفه9`\n"
            " **اكتب الاسم مع الامر للزخرفه فقط انقليزي**\n"
            "•━═━═━═━═━━═━═━═━═━•‌‌\n"
            "˛ 𝐊𝐡𝐚𝐥𝐢𝐉𝐓𝐇𝐎𝐍 𝐔𝐬𝐞𝐫𝐁𝐎𝐓 - [CَِٓHُ](t.me/zvvvn)"
        )
...
async def _(event):
    await event.edit("**يتم تجـهيز بايو اجنبي لأجـلك انتـظر**")
...
async def _(event):
    await event.edit("** يتم تجـهيز بايو عربي لأجـلك انتـظر**")
    await asyncio.sleep(3)
...
@jmthon.ar_cmd(
    pattern="قيفات ساد$",
    command=("قيفات ساد", plugin_category),
)
async def _(event):
    await event.edit(
        "قائمة اوامر قيفات سـاد :\n➖➖➖➖➖➖➖➖➖➖➖➖➖\n ⌯︙اختر احدى هذه القوائم\n\n- ( `.س1` ) \n- ( `.س2` )   \n- (`.س3`)\n- ( `.س4`) \n- ( `.س5` ) \n- ( `.س6` )\n- ( `.س7` )\n- ( `.س8` )\n- ( `.س9` )\n➖➖➖➖➖➖➖➖➖➖➖➖➖\n⌔︙CH : @zVVVn"
    )


@jmthon.ar_cmd(
    pattern="قيفات كيوت$",
    command=("قيفات كيوت", plugin_category),
)
async def _(event):
    await event.edit(
...
@jmthon.ar_cmd(
    pattern="اشهر مزخرفه$",
    command=("اشهر مزخرفه", plugin_category),
)
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
...
@jmthon.ar_cmd(
    pattern="اسماء عربيه$",
    command=("اسماء عربيه", plugin_category),
)
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit(
