...
from userbot import SYVERSION, StartTime, sython
...
@zvvvn.on(sudo_cmd(pattern="فحص$", allow_sudo=True))
async def amireallyalive(event):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "** بـوت خليج ثون يعـمل بنـجـاح **"
...
**{EMOJI} قاعده البيانات :** تعمل بنـجاح
**{EMOJI} أصـدار التـيليثون :** `{telever}`
**{EMOJI} أصـدار خليج ثون :** `{jmver}`
