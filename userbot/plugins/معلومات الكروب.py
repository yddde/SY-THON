...
@jmthon.ar_cmd(
    ...
    info={
        ...
        "description": "⌔︙سيظهـر لك قائمـة المشرفيـن، وإذا ڪنت تستخـدم هـذا الأمـر في مجموعـة عندهـا سيتـم عمـل منشن لهـم 💡",
        "usage": [
            "{tr}المشرفيـن +إسم المستخـدم/معرّف المستخـدم> ✪",
            "{tr}المشرفيـن + في المجموعـة التي تريدهـا> ✪",
        ],
        "examples": "{tr}المشرفين @zvvvn",
    },
)
async def _(event):
