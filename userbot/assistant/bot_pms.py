...
async def bot_pm_ban_cb(c_q: CallbackQuery):
    ...
    try:
        ...
        await c_q.edit(
            f"▾∮ تم حظر المستخدم بسبب التكرار❗️ ↶**\n**▾∮الاسم ⪼ **`{user_name}`\n**▾∮الايدي ⪼ **`{user_id}`\n**▾∮الرابط ⪼** 「{_format.mentionuser(user_name , user_id)}**⍣ⵧⵧⵧⵧⵧ𝖪𝗁𝖺𝗅𝗂𝖩𝖳𝖧𝖮𝖭ⵧⵧⵧⵧⵧ⍣**\n[𝖪𝗁𝖺𝗅𝗂𝖩𝖳𝖧𝖮𝖭 𝖴𝗌𝖾𝗋𝖡𝖮𝖳 ま](https://t.me/zvvvn)"
        )
